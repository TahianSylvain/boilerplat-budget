...
class UnitTests(unittest.TestCase):
    ...
    def test_to_string(self):
        ...
        self.assertEqual(actual.strip(), expected.strip(), 'Expected different string representation of object.')
    ...
    def test_create_spend_chart(self):
        ...
        self.assertEqual(actual.strip(), expected.strip(), 'Expected different chart representation. Check that all spacing is exact.')
